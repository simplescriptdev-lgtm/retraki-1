...
<?php if (!$cats): ?>
  <div class="alert error">Спочатку створіть принаймні одну категорію у розділі «Категорії».</div>
<?php endif; ?>
...
<form method="post" action="/logic/add_item_logic.php" enctype="multipart/form-data">
  ...
  <div class="actions">
    <button class="btn" type="submit" <?= !$cats ? 'disabled' : '' ?>>Зберегти</button>
  </div>
</form>
