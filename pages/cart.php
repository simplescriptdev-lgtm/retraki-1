<?php
// pages/cart.php — перегляд корзини та оформлення переміщення
...
<?php else: ?>
  <table class="table">
    <thead><tr><th>Товар</th><th>SKU</th><th>На складі</th><th>К-сть до переміщення</th><th></th></tr></thead>
    <tbody>
  ...
  <form method="post" action="/logic/cart_logic.php" class="row" style="margin-top:12px;gap:12px">
    ...
    <form method="post" action="/logic/cart_logic.php"><input type="hidden" name="action" value="clear"><button class="btn secondary">Очистити корзину</button></form>
  </form>
<?php endif; ?>
